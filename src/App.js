        ...
        <div className={currentMode === 'Dark' ? 'dark' : ''
            ...
            <BrowserRouter>
                <div className="flex relativ dark:bg-main-dark-bg">
                    ...
                    {activeMenu ? (
                        <div className='w-72 fixed sidebar dark:bg-gray-500 bg-white z-10'>
                            <Sidebar />
                        </div>)
                    ...
                    <div className={`dark:bg-main-dark-bg bg-main-bg min-h-screen w-full ${activeMenu ? 'md:ml-72' : 'flex-column'}`}>
                        <div className="fixed md:static bg-main-bg dark:bg-main-dark-bg navbar w-full z-10"><Navbar /></div>
